...
{
	global $db;
	Zend_Loader::loadClass('Mivec_Page_Pager');
	//require "Mivec/Page/Pager.php";
	...
	$page = new Mivec_Page_Pager($db->fetchOne($rowsql),$limit);
	return array(
		'row'		=> $row,
...
//form select
function formText($_name , $_value , $_class = 'input-text')
{
