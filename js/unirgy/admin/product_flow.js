...
Product.Gallery.prototype = {
    ...
    container :null,
    imageTypes : {},
    initialize : function(containerId, imageTypes, hasImagesValues) {
        this.hasImagesValues = hasImagesValues;
    ...
    onImageTabMove : function(event) {
        var imagesTab = false;
        $(this.containerId).ancestors().each( function(parentItem) {
        ...
        if (imagesTab && event.tab && event.tab.name && imagesTab.name == event.tab.name) {
            $(this.containerId).select('input[type="radio"]').each(function(radio) {
    ...
    handleUploadComplete : function(files) {
        ...
        $(this.containerId).setHasChanges();
        this.updateImages();
    },
...
Product.Configurable.prototype = {
    ...
    updatePositions : function(param) {
        $(this.containerId).childElements().each( function(row, index) {
