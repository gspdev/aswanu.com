...
class Unirgy_DropshipVendorProduct_Model_ProductTypeConfigurable extends Mage_Catalog_Model_Product_Type_Configurable
{
    ...
    public function getUsedProductCollection($product = null)
    {
        ...
        if (Mage::registry('_edit_in_vendor_'.$this->getProduct($product)->getId())) {
