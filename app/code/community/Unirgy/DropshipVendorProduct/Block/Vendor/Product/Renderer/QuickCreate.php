    ...
    public function getGalleryContent()
    {
        if (null === $this->_galleryContent) {
            if (Mage::helper('udropship')->hasMageFeature('uploader')) {
                $galleryContentBlock = 'udprod/vendor_product_galleryCfgContentFlow';
            } else {
                $galleryContentBlock = 'udprod/vendor_product_galleryCfgContent';
            }
            $this->_galleryContent = $this->getLayout()->createBlock($galleryContentBlock);
