...
class Unirgy_Dropship_VendorController extends Unirgy_Dropship_Controller_VendorAbstract
{
    ...
    public function preferencesAction()
    {
        if (Mage::helper('udropship')->isWysiwygAllowed()) {
            $uploaderJs = '_udropship_uploader_js';
            if (Mage::helper('udropship')->hasMageFeature('uploader')) {
                $uploaderJs = '_udropship_uploader_js_flow';
            }
            $this->_renderPage(array('default', 'uwysiwyg_editor', 'uwysiwyg_editor_js', $uploaderJs), 'preferences');
        } else {
...
#echo "<pre>"; print_r($v->debug()); exit;
    ...
    */
    ...
    {
        Mage::helper('udropship')->disableJsHtmlCompress();
