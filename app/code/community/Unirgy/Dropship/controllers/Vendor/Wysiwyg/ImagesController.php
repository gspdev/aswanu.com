...
class Unirgy_Dropship_Vendor_Wysiwyg_ImagesController extends Unirgy_Dropship_Controller_VendorAbstract
{
    ...
    public function indexAction()
    {
        ...
        $handles = array('udropship_overlay_popup');
        if (Mage::helper('udropship')->hasMageFeature('uploader')) {
            $handles[] = '_udropship_vendor_wysiwyg_images_index_flow';
        } else {
            $handles[] = '_udropship_vendor_wysiwyg_images_index';
        }
        $this->_initAction()->loadLayout($handles);
