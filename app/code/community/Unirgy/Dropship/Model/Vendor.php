...
class Unirgy_Dropship_Model_Vendor extends Mage_Core_Model_Abstract
{
    ...
    public function authenticate($username, $password)
    {
        ...
        foreach ($collection as $candidate) {
            if (!$password || !$candidate->getPasswordHash() || !Mage::helper('core')->validateHash($password, $candidate->getPasswordHash())) {
                continue;
            }
    ...
    */
    public function sendOrderNotificationEmail($shipment)
    {
        ...
        $identity = Mage::helper('udropship')->getVendorEmailIdentity($this, $store);
    ...
    protected function _beforeSave()
    {
        ...
        //if ($this->getPassword()) {
            ...
            foreach ($collection as $dup) {
                ...
                if ($this->getPassword() && $dup->getPasswordHash() && Mage::helper('core')->validateHash($this->getPassword(), $dup->getPasswordHash())) {
