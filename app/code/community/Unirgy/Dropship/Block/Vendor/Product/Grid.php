...
class Unirgy_Dropship_Block_Vendor_Product_Grid extends Mage_Core_Block_Template
{
    ...
    protected function _prepareLayout()
    {
        ...
        foreach (array(
            ...
            $store->setConfig('cataloginventory/options/show_out_of_stock', '1');
            Mage::getConfig()->setNode('cataloginventory/options/show_out_of_stock', '1');
        }
    ...
    public function getProductCollection()
    {
        if (!$this->_collection) {
            ...
            $collection = Mage::getResourceModel('udropship/productCollection')
